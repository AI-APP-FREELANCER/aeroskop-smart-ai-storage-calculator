...
const rhinoStorageProducts = [
  {
    id: 1,
    name: "Rhino Storage Server",
    model: "ASK-SR212",
    tagline: "2U High-Capacity Storage Server",
    benefit: "Optimized for high-throughput video storage with enterprise-grade reliability"
  },
  {
    id: 2,
    name: "Rhino Storage Server",
    ...
    benefit: "Enterprise-scale capacity with advanced RAID protection and hot-swap capabilities"
  }
];
...
export default function RhinoServers() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-sky-50/50 to-white">
      ...
      <ProductBanner category="Rhino Storage" imagePath={`${DO_ASSET_BASE_URL}/images/Rhino-storage-server/ASK-SR212.webp`} caption="Enterprise Storage Solutions: Scalable Capacity for Long-Term Retention." />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">
              Rhino Storage Server
            </h1>
            <p className="text-xl text-slate-600 leading-relaxed">
              Scalable storage solutions engineered for reliability, performance, and exceptional value. 
              Our diverse range of high-performance Rhino Storage Servers includes 2U and 4U models, all designed 
              to deliver enterprise-grade storage capacity, advanced RAID protection, and hot-swap capabilities 
              for demanding surveillance workloads and long-term retention in any environment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {rhinoStorageProducts.map((product) => (
              <Link
                key={product.id}
                href={`/rhinoservers/${product.model}`}
