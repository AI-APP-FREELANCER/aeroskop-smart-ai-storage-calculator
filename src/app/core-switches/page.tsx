...
const getImagePath = (model: string): string => {
  ...
  return `/images/Core_Switch/${filename}`;
};

// Product data - simplified for clean card design
const coreSwitchProducts = [
  {
    id: 1,
    name: "Core Switches",
    model: "ASK-E24X10",
    tagline: "24-Port Gigabit with 10G Uplinks",
    benefit: "High-performance core switching with 10G uplinks for enterprise networks"
  },
  {
    id: 2,
    name: "Core Switches",
    ...
    benefit: "Next-generation core distribution with 10G/40G uplinks and advanced Layer 3 features"
  },
  {
    id: 3,
    name: "Core Switches",
    ...
    benefit: "Enterprise-grade switching with low-latency aggregation and redundancy"
  },
  {
    id: 4,
    name: "Core Switches",
    ...
    benefit: "High-performance, low-latency aggregation switch for core network infrastructure"
  }
];
...
export default function CoreSwitches() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-sky-50/50 to-white">
      ...
      <ProductBanner category="Core Switches" imagePath="/images/Core_Switch/ASK-E24X10.webp" caption="High-Performance Core Switching: Enterprise Network Infrastructure." />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              High-performance core switching infrastructure engineered for reliability, scalability, and exceptional value. 
              Our diverse range of core switches includes enterprise-grade models with 10G uplinks, advanced Layer 3 features, 
              and redundancy capabilities, all designed to deliver high-bandwidth connectivity and network reliability for 
              large-scale surveillance networks in any environment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreSwitchProducts.map((product) => (
              <Link
                key={product.id}
                href={`/core-switches/${product.model}`}
