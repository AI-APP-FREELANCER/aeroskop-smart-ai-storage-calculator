...
const cameraProducts = [
  {
    ...
    benefit: "Best-in-class low-light performance for reliable 24/7 monitoring"
  },
  {
    id: 2,
    name: "Dome Camera",
    ...
    benefit: "Advanced AI detection for perimeter security and smart surveillance"
  },
  {
    id: 3,
    name: "Dome Camera",
    ...
    benefit: "Professional-grade precision focus for critical security applications"
  },
  {
    id: 4,
    name: "Dome Camera",
    ...
    benefit: "Intelligent AI analytics with crystal-clear 4K video quality"
  },
  {
    id: 5,
    name: "Bullet Camera",
    ...
    benefit: "Rugged design for harsh outdoor environments with flexible coverage"
  },
  {
    id: 6,
    name: "Bullet Camera",
    ...
    benefit: "Superior night vision capabilities for comprehensive security coverage"
  },
  {
    id: 7,
    ...
    benefit: "Maximum coverage with single-camera panoramic surveillance solution"
  },
  {
    id: 8,
    ...
    benefit: "Dual-lens technology for complete area coverage without blind spots"
  },
  {
    id: 9,
    ...
    benefit: "Long-range monitoring with high-speed pan-tilt-zoom capabilities"
  }
];
...
export default function SecurityCameras() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-sky-50/50 to-white">
      ...
      <ProductBanner category="Security Cameras" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              Comprehensive surveillance solutions engineered for reliability, performance, and exceptional value. 
              Our diverse range of high-performance security cameras includes dome, bullet, PTZ, panoramic, and 
              specialized models, all designed to deliver crystal-clear video with advanced features for 
              comprehensive security coverage in any environment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cameraProducts.map((product) => (
              <Link
                key={product.id}
                href={`/security-cameras/${product.model}`}
