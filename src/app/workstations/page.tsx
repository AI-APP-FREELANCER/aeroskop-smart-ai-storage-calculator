...
const workstationProducts = [
  {
    ...
    benefit: "Optimized for multi-monitor security monitoring and VMS operations"
  },
  {
    id: 2,
    name: "Workstation",
    ...
    benefit: "High-density video editing and playback for control room environments"
  },
  {
    id: 3,
    name: "Workstation",
    ...
    benefit: "Powerful graphics processing for design and visualization workloads"
  },
  {
    id: 4,
    name: "Workstation",
    ...
    benefit: "Neural processing unit optimized for real-time AI analytics"
  }
];
...
export default function Workstations() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-sky-50/50 to-white">
      ...
      <ProductBanner category="Workstations" imagePath="/images/Work_Stations/ASK-WS-i9.webp" caption="Professional Workstations: Optimized for Security Monitoring and VMS Operations." />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              Powerful workstations engineered for reliability, performance, and exceptional value. 
              Our diverse range of high-performance workstations includes Intel i9 and professional models, 
              all designed to deliver multi-monitor support, advanced graphics processing, and AI/ML capabilities 
              for VMS operations, control rooms, and surveillance management in any environment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {workstationProducts.map((product) => (
              <Link
                key={product.id}
                href={`/workstations/${product.model}`}
