...
-- Aeroskop application on DigitalOcean PostgreSQL.
-- 
-- Execution Order:
-- 1. Run this script on your DigitalOcean PostgreSQL database
-- 2. Update your .env.local with the DigitalOcean connection string
-- 3. Test the connection using the application
-- ============================================================================
